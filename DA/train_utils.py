...
class TrainerBase(object):
    ...
    def _get_tradeoff(self, tradeoff_list, epoch=None):
        ...
        for item in tradeoff_list:
            if item == 'exp':
                tradeoff.append(2 / (1 + math.exp(-self.args.zeta * (epoch) / (self.args.max_epoch))) - 1)
    ...
    def train(self):
        ...
        for epoch in range(1, args.max_epoch+1):
            ...
            # Set model to train mode or evaluate modee
            self._set_to_train()
            ...
            if epoch == 2:
                with open('F:\Project\CZSL\code\DA方法\\result-leftaxlebox.csv', 'a') as f:
                    f.write(f"{new_acc}\n")
    ...
    def test(self):
        ...
        # print("啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊",correct['acc']/total['acc'])
