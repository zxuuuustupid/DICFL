...
parser.add_argument('--test_batch_size', type=int, default=2, help="Batch size at test/eval time")
parser.add_argument('--cpu_eval', action='store_true', help='Perform test on cpu')
parser.add_argument('--seed', type=int, default=0, help='seed')

# Model parameters
parser.add_argument('--emb_dim', type=int, default=4, help='dimension of share embedding space')
...
parser.add_argument('--nlayers', type=int, default=1, help='Layers in the image embedder')
parser.add_argument('--cosine_scale', type=float, default=20,help="Scale for cosine similarity")
parser.add_argument('--lambda_rep', type=float, default=1 , help='weight of rep losses at the representation level')
parser.add_argument('--lambda_grad', type=float, default=1 , help='weight of grad losses at the gradient level')
parser.add_argument('--lambda_rec', type=float, default=1 , help='weight of rec losses at the erd')
parser.add_argument('--lambda_res', type=float, default=1 , help='weight of res losses at the erd')
